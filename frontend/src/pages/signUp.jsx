            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  {...firstNameProps}
                  onFocus={(e) => { firstNameProps.onFocus?.(e); handleFocus('firstName'); }}
                  onBlur={(e) => { firstNameProps.onBlur(e); handleBlur(); }}
                />
              ...
              <div className="form-group">
                ...
                />
                {errors.emailId && <div className="error-msg">{errors.emailId.message}</div>}
              </div>
